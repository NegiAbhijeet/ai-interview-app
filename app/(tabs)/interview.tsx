...
const Interview = () => {
  ...
  return (
    <ScreenContainer>
      ...
      <View className="border border-gray-300 rounded-md bg-white mb-4 px-2" style={{ height: 48, justifyContent: 'center' }}>
        <Picker
      ...
      <TextInput
        ...
        className="border border-gray-300 rounded-md px-4 py-3 bg-white mb-4 text-base"
      />
